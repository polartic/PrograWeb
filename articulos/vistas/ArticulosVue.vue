<template>
    ...
    <div>
        ...
        <button @click.prevent="imprimirArticulosPDF" class="btn btn-sm btn-outline-primary" v-if="articulo.length > 0">
            Imprimir <i class="fa fa-print"></i>
        </button>
        &nbsp;
        <button  class="btn btn-sm btn-outline-primary" v-if="articulo.length > 0">
...
import {useArticulo} from '../controladores/useArticulos.ts'
    const {traeArticulo,articulo} = useArticulo()
